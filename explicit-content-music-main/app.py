...
def context(lyrics):
    ...
    category_list = ["Banking Apps/UPI","Crypto Trading","Investment/Trading apps","Personal Finance/Loans"]
    ...
    for i in range(len(response['taxonomy'])):
        ...
        keywords = keywords+response['taxonomy'][i]['tag']+str(response['taxonomy'][i]['confidence_score'])+", "
        print(keywords)
    return keywords
